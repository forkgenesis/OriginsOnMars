...
[Ars Creo 2.2.0](https://modrinth.com/mod/ars-creo/version/2.2.0) | Совместимость между Ars Nouveau и Create | Ars Nouveau 2.9.0, Create 0.5.1.f | Оба
[Ars Nouveau 2.9.0](https://modrinth.com/mod/ars-nouveau/version/2.9.0) | Мод на магию, (СПОЙЛЕРЫ) | Curios API 5.0.9.2, Patchouli 71.1 | Оба
...
[CC:C Bridge 1.5.1](https://modrinth.com/mod/cccbridge/version/1.5.1-forge) | Совместимость между CC: Tweaked и Create | CC: Tweaked 1.101.3, Create 0.5.1.f | Оба
...
[Curios API 5.0.9.2](https://modrinth.com/mod/curios/version/1.18.2-5.0.9.2) | Библиотека для упрощения работы со слотами | | Оба
...
[Drink Beer 1.0.9.5](https://legacy.curseforge.com/minecraft/mc-mods/drink-beer-by-the-buckets/files/4538238) | Пиво | Mantle 1.9.45 | Оба
...
Fan-Made Discs 2.6.0 | Добавляет кастомные музыкальные диски | | Оба
[FerriteCore 4.2.2](https://modrinth.com/mod/ferrite-core/version/4.2.2) | Оптимизация использования памяти Майнкрафтом | | Оба
...
[Mantle 1.9.45](https://legacy.curseforge.com/minecraft/mc-mods/mantle/files/4509007) | Библиотека от mDiyo для Drink Beer | | Оба 
...
[Radon 0.8.1](https://modrinth.com/mod/radon/version/0.8.1) | Форк Phosphor - обновлённого движка освещения Minecraft | | Клиент
...
[Sophisticated Backpacks 3.19.5.990](https://legacy.curseforge.com/minecraft/mc-mods/sophisticated-backpacks/files/4993657) | Мод на рюкзаки | Sophisticated Core 0.5.111.526 | Оба
